...
import {
  listAssetRoomSessions,
  startAssetRoomSession,
} from "@/lib/sugent/asset-room/assetRoomEngine";
...
export async function GET(
  ...
  const data = await listAssetRoomSessions(companyId);
...
export async function POST(
  ...
  const session = await startAssetRoomSession({
    companyId,
