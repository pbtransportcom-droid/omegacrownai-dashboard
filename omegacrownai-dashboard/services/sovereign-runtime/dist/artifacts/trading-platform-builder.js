...
<body>
  <main class="page-shell">
    ...
    <section class="panel visual-preview">
      ...
      <h2>Trading Command Experience</h2>
      <p>This generated package includes SVG hero/card visuals, an asset manifest, and an AI feature-request workflow.</p>
      <div class="visual-grid">
        <img src="./public/images/hero.svg" alt="Trading Command Experience hero visual" />
        <img src="./public/images/feature-1.svg" alt="Market Intelligence visual" />
        <img src="./public/images/feature-2.svg" alt="Risk Controls visual" />
        <img src="./public/images/admin.svg" alt="Trading Admin Dashboard visual" />
      </div>
    </section>
...
`
        ...
        content: JSON.stringify({
            ...
            domain: "trading",
            imagePrompt: "Create polished, production-ready Trading Command Experience visuals with branded hero imagery, feature cards, admin dashboard graphics, and responsive web composition.",
            assets: [
  ...
  <g filter="url(#shadow)">
    ...
    <text x="160" y="390" font-family="Arial, sans-serif" font-size="68" font-weight="900" fill="#111827">Trading Command Experience</text>
  ...
  <g filter="url(#shadow)">
    <rect x="110" y="110" width="980" height="580" rx="48" fill="rgba(255,255,255,.9)"/>
    <text x="160" y="270" font-family="Arial, sans-serif" font-size="104" font-weight="900" fill="#111827">📈</text>
    <text x="160" y="390" font-family="Arial, sans-serif" font-size="68" font-weight="900" fill="#111827">Market Intelligence</text>
    <text x="160" y="470" font-family="Arial, sans-serif" font-size="30" font-weight="700" fill="#4b5563">Generated production visual</text>
    <rect x="160" y="530" width="390" height="68" rx="34" fill="#111827"/>
    <text x="205" y="574" font-family="Arial, sans-serif" font-size="24" font-weight="900" fill="white">Preview-ready asset</text>
  </g>
  ...
  <g filter="url(#shadow)">
    <rect x="110" y="110" width="980" height="580" rx="48" fill="rgba(255,255,255,.9)"/>
    <text x="160" y="270" font-family="Arial, sans-serif" font-size="104" font-weight="900" fill="#111827">📈</text>
    <text x="160" y="390" font-family="Arial, sans-serif" font-size="68" font-weight="900" fill="#111827">Risk Controls</text>
    <text x="160" y="470" font-family="Arial, sans-serif" font-size="30" font-weight="700" fill="#4b5563">Generated production visual</text>
    <rect x="160" y="530" width="390" height="68" rx="34" fill="#111827"/>
    <text x="205" y="574" font-family="Arial, sans-serif" font-size="24" font-weight="900" fill="white">Preview-ready asset</text>
  </g>
  ...
  <g filter="url(#shadow)">
    <rect x="110" y="110" width="980" height="580" rx="48" fill="rgba(255,255,255,.9)"/>
    <text x="160" y="270" font-family="Arial, sans-serif" font-size="104" font-weight="900" fill="#111827">📈</text>
    <text x="160" y="390" font-family="Arial, sans-serif" font-size="68" font-weight="900" fill="#111827">Trading Admin Dashboard</text>
    <text x="160" y="470" font-family="Arial, sans-serif" font-size="30" font-weight="700" fill="#4b5563">Generated production visual</text>
    <rect x="160" y="530" width="390" height="68" rx="34" fill="#111827"/>
    <text x="205" y="574" font-family="Arial, sans-serif" font-size="24" font-weight="900" fill="white">Preview-ready asset</text>
  </g>
    ...
    files.push({
        ...
        type: "json",
        content: JSON.stringify({
            brand: "King Trading System",
            type: "trading",
            hero: {
                eyebrow: "Full-function generated application",
                headline: "King Trading System is a full-function trading command platform with signals, watchlists, risk controls, journal workflows, and admin operations.",
                subheadline: "Traders can monitor signals, review risk, manage journal workflows, open admin tools, and ask AI for more trading features."
            },
            pages: [
...
export default function EditorPage() {
  return (
    <main className="min-h-screen bg-black p-8 text-white">
      <p className="text-sm font-black uppercase tracking-[0.3em] text-emerald-300">Generated App Editor</p>
      <h1 className="mt-4 text-5xl font-black">Edit King Trading System content and request new AI features</h1>
