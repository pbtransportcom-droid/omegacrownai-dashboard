...
function commerceBrand(plan) {
    const value = safe(plan.business.brandName);
    if (!value ||
        /commerce platform|ecommerce platform|online store|custom business/i.test(value)) {
        return "Crown Market";
    }
    return value;
}
export function renderCommerceLivingOS(plan) {
    if (plan.industry !== "commerce") {
        throw new Error(`Commerce renderer received ${plan.industry}`);
    }
        ...
        content: JSON.stringify([
            {
                ...
                category: "Travel",
                description: "Premium structured weekender with durable hardware and organized interior storage.",
                price: 168,
                compareAtPrice: 198,
                inventory: 24,
                rating: 4.9,
            ...
            },
            {
                ...
                category: "Bags",
                description: "A refined daily tote with structured handles, interior pockets, and secure closure.",
                price: 142,
                compareAtPrice: null,
                inventory: 18,
                rating: 4.8,
            ...
            },
            {
                ...
                description: "Slim travel wallet for cards, passport, boarding passes, and essential documents.",
                price: 64,
                compareAtPrice: 78,
                inventory: 42,
                rating: 4.7,
            ...
            },
            {
                ...
                category: "Office",
                description: "Coordinated desk accessories designed for modern workspaces and executive gifting.",
                price: 118,
                compareAtPrice: null,
                inventory: 16,
                rating: 4.8,
        ...
        content: JSON.stringify([
            {
                id: "new-arrivals",
                name: "New Arrivals",
                description: "Recently added products and seasonal releases.",
            },
            {
                id: "best-sellers",
                name: "Best Sellers",
                description: "Customer favorites and most-purchased products.",
            },
            {
                id: "travel",
                name: "Travel Essentials",
                description: "Premium products designed for work and leisure travel.",
            },
            {
                id: "gifts",
                name: "Gift Collection",
                description: "Curated products for celebrations, corporate gifting, and special occasions.",
            },
        ], null, 2),
    });
    files.push({
