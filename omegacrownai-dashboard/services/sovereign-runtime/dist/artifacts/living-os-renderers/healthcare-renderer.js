...
function healthcareBrand(plan) {
    const value = safe(plan.business.brandName);
    if (!value ||
        /healthcare platform|clinic platform|medical platform|custom business/i.test(value)) {
        return "CrownCare Medical Group";
    }
    return value;
}
export function renderHealthcareLivingOS(plan) {
    if (plan.industry !== "healthcare") {
        throw new Error(`Healthcare renderer received ${plan.industry}`);
    }
        ...
        content: JSON.stringify([
            {
                id: "primary-care",
                name: "Primary Care",
                description: "Preventive visits, chronic-condition support, annual exams, and coordinated care.",
            },
            {
                id: "urgent-care",
                name: "Urgent Care",
                description: "Same-day assessment for non-emergency illnesses, injuries, and time-sensitive concerns.",
            },
            {
                id: "telehealth",
                name: "Telehealth",
                description: "Secure virtual appointments for follow-up care, consultations, and routine needs.",
            },
            {
                id: "pediatrics",
                name: "Pediatrics",
                description: "Well-child visits, developmental guidance, vaccinations, and pediatric care.",
            },
            {
                id: "womens-health",
                name: "Women's Health",
                description: "Preventive screenings, wellness visits, and coordinated women's healthcare.",
            },
            {
                id: "behavioral-health",
                name: "Behavioral Health",
                description: "Confidential mental-health support, care plans, and follow-up services.",
            },
        ], null, 2),
    });
    files.push({
...
`,
    ...
    const apiRoutes = [
        ...
        "insurance",
        "telehealth",
        // HEALTHCARE_AUTHORITATIVE_API_CONTRACT
        "appointment-request",
        "patient-intake",
    ];
...
`,
    ...
    // HEALTHCARE_DELIVERY_SHELL_CONTRACT
    files.push({
        file: "app/layout.tsx",
        title: "Healthcare Root Layout",
        type: "typescript",
...
export const metadata = {
  ...
  description:
    "Healthcare appointments, patient intake, providers, care coordination, and clinic operations.",
};
...
`,
    ...
    files.push({
        file: "README.md",
        title: "Healthcare Clinic Operations README",
        type: "markdown",
        content: `# Healthcare Clinic Operations Platform

Generated by OmegaCrownAI.

## Overview

This generated application provides a production-oriented foundation for healthcare clinic operations, including appointment requests, patient intake, providers, patient records, care plans, communications, documents, prescriptions, billing, insurance, and telehealth workflows.
...
Customer-facing workflow APIs:

- \`/api/appointment-request\`
- \`/api/patient-intake\`

Operational healthcare APIs include:
...
Configure the production database, authentication, email, storage, telehealth, billing, insurance, and other integrations required by the deployment environment.
