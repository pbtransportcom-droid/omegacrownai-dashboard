...
function legalBrand(plan) {
    const value = safe(plan.business.brandName);
    if (!value ||
        /legal platform|law firm platform|custom business/i.test(value)) {
        return "Sterling & Crown Legal";
    }
    return value;
}
export function renderLegalLivingOS(plan) {
    if (plan.industry !== "legal") {
        throw new Error(`Legal renderer received ${plan.industry}`);
    }
        ...
        content: JSON.stringify([
            {
                id: "business-law",
                name: "Business Law",
                description: "Business formation, contracts, governance, disputes, and strategic legal counsel.",
            },
            {
                id: "personal-injury",
                name: "Personal Injury",
                description: "Case evaluation, evidence review, negotiation, and litigation support.",
            },
            {
                id: "family-law",
                name: "Family Law",
                description: "Divorce, custody, support, mediation, and family legal planning.",
            },
            {
                id: "estate-planning",
                name: "Estate Planning",
                description: "Wills, trusts, probate guidance, powers of attorney, and legacy planning.",
            },
            {
                id: "real-estate",
                name: "Real Estate Law",
                description: "Transactions, leases, closings, title matters, and property disputes.",
            },
            {
                id: "employment",
                name: "Employment Law",
                description: "Workplace agreements, disputes, compliance, and employee or employer representation.",
            },
        ], null, 2),
    });
    files.push({
...
`,
    ...
    files.push({
        file: "app/layout.tsx",
        title: "Legal Root Layout",
        type: "typescript",
        content: `import "./globals.css";
import type { ReactNode } from "react";

export const metadata = {
  title: "Legal Practice Operations",
  description:
    "Legal intake, case management, consultations, matters, and practice operations.",
};
...
`,
    ...
    // LEGAL_DELIVERY_README_CONTRACT
    files.push({
        file: "README.md",
        title: "Legal Practice Operations README",
        type: "markdown",
        content: `# Legal Practice Operations Platform

Generated by OmegaCrownAI.

## Overview

This application provides a production-oriented foundation for legal practice operations, including client intake, matters, cases, consultations, documents, tasks, billing, messaging, conflicts, and administrative workflows.
...
Configure production environment variables, database access, authentication, payment providers, email providers, storage providers, and other integrations required by the deployment environment.
