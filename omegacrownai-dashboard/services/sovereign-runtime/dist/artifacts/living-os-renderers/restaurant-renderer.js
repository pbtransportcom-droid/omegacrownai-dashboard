...
function restaurantBrand(plan) {
    const value = safe(plan.business.brandName);
    if (!value ||
        /restaurant platform|food ordering platform|custom business/i.test(value)) {
        return "Crown Table Kitchen";
    }
    return value;
}
export function renderRestaurantLivingOS(plan) {
    if (plan.industry !== "restaurant") {
        throw new Error(`Restaurant renderer received ${plan.industry}`);
    }
        ...
        content: JSON.stringify([
            {
                ...
                category: "Dinner",
                description: "Atlantic salmon, lemon herb butter, seasonal vegetables, and roasted potatoes.",
                price: 28,
                available: true,
                dietary: ["Gluten-Free"],
            },
            {
                ...
                category: "Dinner",
                description: "Slow-braised beef short rib, whipped potatoes, red wine jus, and glazed carrots.",
                price: 32,
                available: true,
                dietary: [],
            },
            {
                ...
                category: "Dinner",
                description: "Arborio rice, wild mushrooms, parmesan, herbs, and truffle oil.",
                price: 24,
                available: true,
                dietary: ["Vegetarian"],
            },
            {
                ...
                category: "Brunch",
                description: "Eggs, artisan toast, seasonal fruit, breakfast potatoes, and chef-selected sides.",
                price: 22,
                available: true,
                dietary: [],
            },
            {
                ...
                category: "Dessert",
                description: "Dark chocolate custard, cocoa crust, whipped cream, and sea salt.",
                price: 11,
                available: true,
                dietary: ["Vegetarian"],
            },
