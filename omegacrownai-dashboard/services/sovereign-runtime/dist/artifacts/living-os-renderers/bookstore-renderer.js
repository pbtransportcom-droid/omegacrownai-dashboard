function safeBrand(plan) {
    const value = String(plan.business.brandName || "BookHaven").trim();
    if (!value ||
        /commerce store website|custom business website/i.test(value)) {
        return "BookHaven";
    }
    return value;
}
function bookSeed(brand) {
    return [
        {
            id: "book-001",
            ...
            author: "Nora Vale",
            category: "Fiction",
            description: "A moving literary novel about memory, possibility, and the lives we choose.",
            price: 18.99,
            rating: 4.8,
            reviewCount: 1284,
            formats: [
        ...
        },
        {
            ...
            author: "Mara Ellison",
            category: "Mystery",
            description: "A layered mystery about a vanished manuscript and a secret literary society.",
            price: 16.5,
            rating: 4.7,
            reviewCount: 842,
            formats: [
        ...
        },
        {
            ...
            author: "Ibrahim Cole",
            category: "Sci-Fi",
            description: "A cinematic science-fiction journey across floating cities and forgotten worlds.",
            price: 21,
            rating: 4.9,
            reviewCount: 1139,
            formats: [
        ...
        },
        {
            ...
            author: "Elena Hart",
            category: "Romance",
            description: "A warm romance about second chances, family traditions, and a neighborhood bookshop.",
            price: 14.99,
            rating: 4.6,
            reviewCount: 692,
            formats: [
        ...
        },
        {
            ...
            category: "Self-Help",
            description: "A practical guide to sustainable habits, focus, and meaningful personal growth.",
            price: 17.75,
            rating: 4.8,
            reviewCount: 954,
            formats: [
        ...
        },
        {
            ...
            description: "An illustrated journey through oceans, forests, deserts, and the night sky.",
            price: 22.5,
            rating: 4.9,
            reviewCount: 488,
            formats: [
...
function svgCover(title, author, background, accent) {
...
export function renderBookstoreLivingOS(plan) {
    if (plan.industry !== "bookstore") {
        throw new Error(`Bookstore renderer received industry ${plan.industry}`);
    }
    ...
    for (const [file, title, author, background, accent,] of coverDefinitions) {
        files.push({
            file: `public/images/books/${file}`,
            title: `${title} Cover`,
            type: "svg",
            content: svgCover(title, author, background, accent),
        });
    }
    files.push({
...
`,
    ...
    files.push({
        file: "app/api/secure-stripe-or-square-checkout/route.ts",
        title: "Secure Stripe or Square Checkout API",
        type: "typescript",
        content: `import { NextResponse } from "next/server";
...
`,
    ...
    files.push({
        file: "app/api/book-format-selection/route.ts",
        title: "Book Format Selection API",
        type: "typescript",
        content: `import { NextResponse } from "next/server";
