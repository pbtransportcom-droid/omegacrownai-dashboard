...
export function isFinancePlatformPrompt(prompt) {
...
document.addEventListener('keydown',function(e){if(e.key==='Escape')closeTx()});load();render();
    ...
    const svg = (title, bg, fg) => `<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900"><rect width="1600" height="900" rx="64" fill="${bg}"/><text x="100" y="220" fill="${fg}" font-size="82" font-family="Arial" font-weight="900">${title}</text><rect x="100" y="380" width="360" height="250" rx="34" fill="white" opacity=".14"/><rect x="520" y="380" width="360" height="250" rx="34" fill="white" opacity=".14"/><rect x="940" y="380" width="360" height="250" rx="34" fill="white" opacity=".14"/></svg>`;
