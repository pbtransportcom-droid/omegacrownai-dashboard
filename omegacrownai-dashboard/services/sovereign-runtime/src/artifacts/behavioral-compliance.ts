  ...
  return [
    requirement(
      artifacts,
      {
        ...
        label:
          "Financial account and transaction operations",
        files: [
    ...
    requirement(
      artifacts,
      {
        ...
        label:
          "Financial statements, reporting, and payment operations",
        files: [
    ...
    requirement(
      artifacts,
      {
        ...
        label:
          "Financial risk, compliance, and audit operations",
        files: [
    ...
    requirement(
      artifacts,
      {
        ...
        label:
          "Persistent financial operating records",
        files: [
          "lib/finance-store.ts",
          "data/accounts.json",
