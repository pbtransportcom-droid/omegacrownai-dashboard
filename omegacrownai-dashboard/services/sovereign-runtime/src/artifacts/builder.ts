...
export async function buildArtifacts(run: any) {
  ...
  const restaurantFromSpec =
    specIndustry === "restaurant" ||
  ...
  const financeFromSpec =
    specIndustry === "finance";

  const tradingFromSpec =
        ...
        productionScaffold.push(
          {
            file: ".env.example",
            title:
              "Bookstore Environment Template",
            type: "text",
...
NEXT_PUBLIC_APP_NAME="${
              ...
              (run as any)?.buildSpec?.brandName ||
              "BookHaven"
            }"
...
`,
          },
          {
            file: "README.md",
            title:
              "BookHaven Production Delivery Guide",
            type: "markdown",
            content: `# ${
              (run as any)?.productName ||
              (run as any)?.buildSpec?.brandName ||
...
`,
          },
          {
            file: "README.md",
            title:
              "CrownLedger Finance Delivery Guide",
            type: "markdown",
            content: `# ${
              (run as any)?.productName ||
              (run as any)?.buildSpec?.brandName ||
