...
Paper-trading starter repository generated by OmegaCrownAI Trading Builder.
...
- Broker withdrawal permissions: not allowed
...
1. Replace placeholder market data with paper data providers.
2. Add historical OHLCV loader.
3. Improve backtest engine.
4. Add paper broker adapters.
5. Run 2–4 weeks in paper trading mode.
6. Review logs and risk decisions.
7. Only then consider live trading setup with strict safety gates.
`,
    },
  ];
